...
If you want external policy evaluation, `Agent_Sudo` can be called from `before_tool_execute` via function hook.

- Project: [ram9199/agent_sudo](https://github.com/ram9199/agent_sudo)
