...
| Model ID | Display Name | Required Env Vars |
|----------|--------------|-------------------|
| `bedrock:anthropic.claude-sonnet-4-5-20250514-v1:0` | Claude Sonnet 4.5 (Bedrock) | `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY` |
| `bedrock:anthropic.claude-3-5-haiku-20241022-v1:0` | Claude 3.5 Haiku (Bedrock) | `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY` |
| `bedrock:amazon.nova-pro-v1:0` | Amazon Nova Pro | `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY` |
| `bedrock:amazon.nova-lite-v1:0` | Amazon Nova Lite | `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY` |
| `bedrock:meta.llama3-3-70b-instruct-v1:0` | Llama 3.3 70B (Bedrock) | `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY` |
...
- `bedrock:anthropic.claude-sonnet-4-5-20250514-v1:0` - AWS Bedrock
