...
OAuth triggers a browser-based login on first use. For full OAuth setup with Agent Runtimes, see the [Kaggle OAuth Setup](/docs/identity#kaggle-oauth-setup) in the Identity documentation.

**Option 2: Token Authentication**

For non-interactive or automated use:
...
2. Click **Generate New Token** > **Copy** (token starts with `KGAT`)
3. Set the environment variable: `export KAGGLE_TOKEN=KGAT...`
