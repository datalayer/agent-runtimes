...
| Interactive or triggered workflows | [Agent Specs](/agentspecs), [Endpoints](/endpoints) |
...
| Real-time collaboration with users, subagents, and multi-agent teams | [Protocols](/protocols), [Endpoints](/endpoints#acp-protocol-websocket), [Agent Specs](/agentspecs) |
