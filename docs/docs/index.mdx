...
├──────────────────────────┬──────────────────────────────────┤
│      mcp-codemode        │         agent-skills             │
│  (Tool discovery, codegen)│    (Skill management)           │
├──────────────────────────┴──────────────────────────────────┤
│                    code-sandboxes                           │
...
- ✅ Integration layer for mcp-codemode and agent-skills

**Not Responsible For:**
- ❌ MCP tool binding generation (→ mcp-codemode)
