...
export const NOTEBOOK_BENCHMARK_TEAM_SPEC_0_0_1: TeamSpec = {
  ...
  emoji: '🧪',
  color: '#1ABC9C',
  agentSpecId: 'jupyter-data-analyst:0.0.1',
  orchestrationProtocol: 'datalayer',
  executionMode: 'sequential',
  supervisor: {
  ...
  routingInstructions: `Place the runner first and wait for it: nothing can be analysed before the notebook has run. Give the analyst the runner's outputs and the evalset's expectations, and the reviewer the analyst's comparison. Answer with the reviewer's verdict and the evidence behind it, never with a summary of your own that nothing produced.`,
  delegation: {
    maxDepth: 2,
    allowPeerDelegation: false,
    includeGeneralPurpose: false,
