...
export const SHARED_NOTEBOOK_TEAM_SPEC_0_0_1: TeamSpec = {
  ...
  description: `Analyst, Reviewer and Writer, working in the same Jupyter notebook: the Analyst adds and runs the cells, the Reviewer checks them and records what it finds, the Writer writes the result up between them.`,
  tags: ['notebook', 'jupyter', 'collaboration', 'analysis', 'review'],
  enabled: true,
  icon: 'people',
  emoji: '🧑‍🤝‍🧑',
  color: '#0969DA',
