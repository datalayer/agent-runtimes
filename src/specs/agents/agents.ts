...
export const DEMO_OUTPUTS_AGENTSPEC_0_0_1: Agentspec = {
  ...
  welcomeMessage:
    'Outputs demo agent ready. Ask for TABLE, JSON, CHART, or FILE formats and I will respond with exactly one structured output block.',
  welcomeNotebook: undefined,
  welcomeDocument: undefined,
  sandboxVariant: 'jupyter',
...
export const GALLERY_AGENT_CRITIC_LOOP_FOR_ANALYSIS_AGENTSPEC_0_0_1: Agentspec =
  {
    ...
    color: '#1F883D',
    suggestions: [
      'Start this workflow and provide a sample dataset I can analyze.',
      'Run an end-to-end analysis and summarize the top findings clearly.',
      'Highlight anomalies, trends, and suggested next actions.',
      'Show the code you run and explain each step briefly.',
    ],
    welcomeMessage:
...
export const GALLERY_ANALYZE_EXCEL_SPREADSHEET_AGENTSPEC_0_0_1: Agentspec = {
  ...
  suggestions: [
    ...
    'Use a well-known public Kaggle dataset (for example House Prices or Titanic), load it, and run a compact exploratory analysis with actionable findings.',
  ],
  welcomeMessage:
