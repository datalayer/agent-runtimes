...
const TOOL_MAP: Record<string, any> = {
  ...
  'example-generate-task-steps:0.0.1': EXAMPLE_GENERATE_TASK_STEPS_TOOL_SPEC_0_0_1,
  ...
  'example-render-a2ui-surface:0.0.1': EXAMPLE_RENDER_A2UI_SURFACE_TOOL_SPEC_0_0_1,
...
const FRONTEND_TOOL_MAP: Record<string, any> = {
  ...
  'jupyter-notebook-propose:0.0.1': JUPYTER_NOTEBOOK_PROPOSE_FRONTEND_TOOL_SPEC_0_0_1,
...
export const EXAMPLE_A2UI_AGENT_SPEC_0_0_1: Agentspec = {
    ...
    frontendTools: [],
    frontendRenderTools: [{"tool": "render_a2ui_surface", "renderer": "a2ui-surface"}],
    ...
    welcomeMessage: "Hi! I turn requests into interactive A2UI surfaces. Ask me to build a form, survey, configurator or booking flow and I'll render it live for you.\n",
...
export const EXAMPLE_AGENTIC_GENERATIVE_UI_AGENTSPEC_0_0_1: Agentspec = {
    ...
    mcpServers: [],
    skills: [].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['example-create-plan:0.0.1'], TOOL_MAP['example-update-plan-step:0.0.1']],
    frontendTools: [],
    environmentName: 'ai-agents-env',
    icon: 'list-unordered',
    emoji: '📋',
    ...
    welcomeMessage: "Hi! Give me a goal and I'll create a plan, then work through the steps.\n",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: undefined,
    harness: 'pydantic-ai',
...
export const EXAMPLE_BACKEND_TOOL_RENDERING_AGENTSPEC_0_0_1: Agentspec = {
    ...
    frontendTools: [],
    frontendRenderTools: [{"tool": "get_weather", "renderer": "weather-card", "css": "weather-card.css"}],
    environmentName: 'ai-agents-env',
    icon: 'sun',
    emoji: '🌤️',
    color: '#6366F1',
...
export const EXAMPLE_CODEMODE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    skills: [(SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
...
export const EXAMPLE_EVALS_NOCODEMODE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Ready to run eval experiments without codemode enabled. Configure your benchmark and evaluator setup, then launch a run.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const EXAMPLE_FULL_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['tavily:0.0.1']],
    skills: [(SKILL_MAP['crawl:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['crawl:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined), (SKILL_MAP['github:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['github:0.0.1']) : undefined), (SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined), (SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['jokes:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['jokes:0.0.1']) : undefined), (SKILL_MAP['datalayer-whoami:1.0.0'] ? toAgentSkillSpec(SKILL_MAP['datalayer-whoami:1.0.0']) : undefined)].filter(Boolean) as SkillSpec[],
...
This agent also demonstrates pydantic-ai tool execution hook naming: before_tool_execute, after_tool_execute, on_tool_execute_error, and deferred_tool_calls.`,
    ...
    preHooks: undefined,
    postHooks: undefined,
    toolHooks: {"actor": "${USER}", "audit_log_path": "agent_runtimes_tool_approvals_audit.jsonl", "current_delegations": ["delegate:guardrails-low-risk"], "before_tool_execute": [{"function": "agent_runtimes.integrations.tool_policy:evaluate_tool_request"}, {"python": "reason = str(request.get(\"arguments\", {}).get(\"reason\", \"\")).lower()\nif \"delete\" in reason:\n    hook_result = {\n        \"decision\": \"deny\",\n        \"reason\": \"guardrails_local_delete_policy\"\n    }\n"}], "after_tool_execute": [{"python": "print(\n    \"[example-guardrails] after_tool_execute\",\n    payload.get(\"tool\"),\n    payload.get(\"status\"),\n    payload.get(\"decision\"),\n)\n"}], "on_tool_execute_error": [{"python": "print(\n    \"[example-guardrails] on_tool_execute_error\",\n    payload.get(\"tool\"),\n    payload.get(\"error_type\"),\n    payload.get(\"decision\"),\n)\n"}], "deferred_tool_calls": [{"python": "print(\"[example-guardrails] deferred_tool_calls invoked\")\n"}]},
    parameters: undefined,
    subagents: undefined,
};
...
export const EXAMPLE_HAIKU_GENERATIVE_UI_AGENTSPEC_0_0_1: Agentspec = {
    ...
    frontendTools: [],
    frontendRenderTools: [{"tool": "generate_haiku", "renderer": "haiku-card", "css": "haiku-card.css"}],
    environmentName: 'ai-agents-env',
    icon: 'pencil',
    emoji: '🖋️',
    color: '#6366F1',
...
export const EXAMPLE_HUMAN_IN_THE_LOOP_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! Describe a task and I'll draft a step-by-step plan for you to review.\n",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: undefined,
    harness: 'pydantic-ai',
...
export const EXAMPLE_MCP_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['tavily:0.0.1']],
    skills: [(SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined), (SKILL_MAP['jokes:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['jokes:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'globe',
...
export const EXAMPLE_MEMORY_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Ready to demonstrate durable memory. I persist stable facts and preferences (name, preferences, constraints), and can recall them across turns/restarts. I do not persist every transient sentence.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const EXAMPLE_ONE_TRIGGER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [],
    skills: [(SKILL_MAP['github:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['github:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'zap',
...
export const EXAMPLE_OUTPUT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Example output agent ready. Ask for TABLE, JSON, CHART, or FILE formats and I will respond with exactly one structured output block.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const EXAMPLE_SANDBOX_COLAB_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the google-colab sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
...
export const EXAMPLE_SANDBOX_DATALAYER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the datalayer sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
...
export const EXAMPLE_SANDBOX_DOCKER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the docker sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
...
export const EXAMPLE_SANDBOX_EVAL_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the eval sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'eval',
    harness: 'pydantic-ai',
...
export const EXAMPLE_SANDBOX_JUPYTER_SERVER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the jupyter-server sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const EXAMPLE_SANDBOX_JUPYTER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the jupyter sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const EXAMPLE_SANDBOX_KAGGLE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the kaggle sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
...
export const EXAMPLE_SANDBOX_MODAL_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the modal sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
...
export const EXAMPLE_SANDBOX_MONTY_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "You're connected to the monty sandbox variant demo. Ask me to run Python code and I will use execute_code in codemode.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
...
export const EXAMPLE_SHARED_STATE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! Tell me what you'd like to cook and I'll build a recipe with you.\n",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: undefined,
    harness: 'pydantic-ai',
...
export const EXAMPLE_TOOL_APPROVALS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    mcpServers: [],
    skills: [].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-sensitive-echo:0.0.1'], TOOL_MAP['runtime-echo:0.0.1']],
    frontendTools: [],
    environmentName: 'ai-agents-env',
    icon: 'pi pi-shield',
    emoji: '✅',
...
`,
    ...
    preHooks: undefined,
    postHooks: undefined,
    toolHooks: {"actor": "${USER}", "audit_log_path": "agent_runtimes_tool_approvals_audit.jsonl", "current_delegations": ["delegate:read-only-low-risk"], "before_tool_execute": [{"function": "agent_runtimes.integrations.tool_policy:evaluate_tool_request"}, {"python": "reason = str(request.get(\"arguments\", {}).get(\"reason\", \"\")).lower()\nif \"delete\" in reason or \"drop\" in reason:\n    hook_result = {\n        \"decision\": \"deny\",\n        \"reason\": \"blocked_by_local_python_reason_policy\"\n    }\nelif request.get(\"risk_class\") == \"low\":\n    hook_result = {\n        \"decision\": \"delegated_allow\",\n        \"reason\": \"delegated_low_risk_auto_allow\"\n    }\n"}], "after_tool_execute": [{"python": "print(\n    \"[example-tool-approvals]\",\n    payload.get(\"tool\"),\n    payload.get(\"status\"),\n    payload.get(\"decision\"),\n)\n"}], "on_tool_execute_error": [{"python": "print(\n    \"[example-tool-approvals:error]\",\n    payload.get(\"tool\"),\n    payload.get(\"error_type\"),\n    payload.get(\"decision\"),\n)\n"}], "deferred_tool_calls": [{"python": "print(\"[example-tool-approvals] deferred_tool_calls invoked\")\n"}]},
    parameters: undefined,
    subagents: undefined,
};
...
export const EXAMPLE_TOOL_BASED_GENERATIVE_UI_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! Ask me to show something and I'll render it using the available UI tools.\n",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: undefined,
    harness: 'pydantic-ai',
...
export const GALLERY_ACCOUNTANT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    skills: [(SKILL_MAP['accounting:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['accounting:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'book',
    ...
    welcomeMessage: "Hi! I am your Accountant agent for Odoo workflows. I can help reconcile invoices and payments, analyze journals, and prepare close-ready summaries.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_AGENT_CRITIC_LOOP_FOR_ANALYSIS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with agent critic loop for analysis. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_AGENT_REVIEWS_SQL_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with agent reviews sql. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_AI_CREATES_DASHBOARDS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with ai creates dashboards. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_AI_EXPLAINS_NOTEBOOK_OUTPUT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with ai explains notebook output. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_AI_WRITES_PANDAS_CODE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with ai writes pandas code. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_ANALYZE_CAMPAIGN_PERFORMANCE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    skills: [(SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined), (SKILL_MAP['crawl:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['crawl:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'megaphone',
...
export const GALLERY_ANALYZE_EXCEL_SPREADSHEET_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with analyze an excel spreadsheet. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_AUDIT_INVENTORY_LEVELS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['filesystem:0.0.1'], MCP_SERVER_MAP['slack:0.0.1']],
    skills: [(SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'package',
...
export const GALLERY_BUILD_NOTEBOOK_WITH_ONE_PROMPT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with build a notebook with one prompt. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_COMPARE_TWO_SPREADSHEETS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with compare two spreadsheets. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_COMPLIANCE_REPORT_DRAFT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with compliance report draft. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_COMPREHENSIVE_SALES_ANALYTICS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['filesystem:0.0.1'], MCP_SERVER_MAP['slack:0.0.1']],
    skills: [(SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined), (SKILL_MAP['github:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['github:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'graph',
...
export const GALLERY_COST_COMPARISON_REPORT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with cost comparison report. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_CUSTOMER_CHURN_ANALYSIS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with customer churn analysis. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_DOCUMENT_QA_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with document q&a. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_EXPLORE_SQL_DATABASE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with explore a sql database. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_EXTRACT_KPIS_FROM_QUARTERLY_PDF_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with extract kpis from quarterly pdf. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_FINANCIAL_RECONCILIATION_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with financial reconciliation. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_FIVE_AI_AGENTS_ANALYZE_CSV_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with five ai agents analyze a csv. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_FIVE_NOTEBOOKS_IN_PARALLEL_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with five notebooks in parallel. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_GPT_AND_CLAUDE_COLLABORATE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with gpt and claude collaborate. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_HUMAN_APPROVED_AUTOMATION_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with human-approved automation. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_INSURANCE_CLAIMS_REVIEW_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with insurance claims review. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_INVENTORY_DEMAND_PLANNING_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with inventory demand planning. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_LONG_RUNNING_AGENT_OVERNIGHT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with long-running agent overnight. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_MARKETING_ANALYTICS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with marketing analytics. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_MEDICAL_RESEARCH_REVIEW_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with medical research review. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_MONITOR_SALES_KPIS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['filesystem:0.0.1']],
    skills: [(SKILL_MAP['github:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['github:0.0.1']) : undefined), (SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
...
export const GALLERY_MULTI_AGENT_DATA_CLEANING_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with multi-agent data cleaning. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_MULTI_AGENT_ROOT_CAUSE_ANALYSIS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with multi-agent root cause analysis. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_OPTIMIZE_SQL_QUERY_PERFORMANCE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with optimize sql query performance. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_REPLACE_EXCEL_PIVOT_WORK_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with replace excel pivot work. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_RESUMABLE_ETL_WITH_CHECKPOINTS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with resumable etl with checkpoints. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_RUN_PYTHON_SAFELY_IN_THE_CLOUD_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with run python safely in the cloud. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_SALES_FORECASTING_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with sales forecasting. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_SALES_PIPELINE_BOARD_REPORT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with sales pipeline board report. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_SCHEDULED_NIGHTLY_DATA_QUALITY_CHECKS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with scheduled nightly data quality checks. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_SCIENTIFIC_NOTEBOOK_ASSISTANT_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with scientific notebook assistant. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_SUMMARIZE_10_PDFS_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with summarize 10 pdfs. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const GALLERY_WEEKLY_EXECUTIVE_BRIEFING_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I can help with weekly executive briefing. Share data, files, or context and I will run the workflow end-to-end, explain what matters, and suggest practical next steps.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const JUPYTER_CELL_FIXER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I fix failing cells. Show me the cell and its traceback and I will explain what went wrong, propose a change you can read before accepting, and run it to prove it works.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const JUPYTER_NOTEBOOK_COMPACTOR_INBROWSER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I make notebooks shorter without making them different — and I do it right here in your browser, with nothing installed and nobody signed in. Point me at the notebook on this page and I will merge what belongs together, remove dead code and stale outputs, and tell you exactly how many cells and lines went.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: undefined,
    harness: 'vercel-ai',
...
export const JUPYTER_NOTEBOOK_COMPACTOR_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I make notebooks shorter without making them different. Point me at the notebook you have open and I will merge what belongs together, remove dead code and stale outputs, and tell you exactly how many cells and lines went.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const JUPYTER_NOTEBOOK_REPRODUCER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I check whether a notebook still works for someone who is not you. I run it top to bottom on a fresh sandbox and report what fails, what depends on state you happen to have, and what a new reader would be missing.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const LOOP_BASE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I drive the notebook and the document beside this conversation, and I run code in the sandbox. Ask for something, or hand work to a specialist with @NotebookCompactor, @CellFixer or @NotebookReproducer.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
3. Say what you changed, in the reader's terms, after you change it. 4. When something cannot be done, say why instead of producing a plausible
   substitute.`,
    ...
    toolHooks: undefined,
    parameters: undefined,
    subagents: {"includeGeneralPurpose": true, "maxNestingDepth": 2, "subagents": [{"name": "NotebookCompactor", "ref": "jupyter-notebook-compactor:0.0.1", "description": "Rewrites the notebook as short as it can be without changing what it computes. Use when a notebook has grown repetitive or full of dead code."}, {"name": "CellFixer", "ref": "jupyter-cell-fixer:0.0.1", "description": "Fixes a failing cell and proves the fix by running it. Use when a cell raises."}, {"name": "NotebookReproducer", "ref": "jupyter-notebook-reproducer:0.0.1", "description": "Runs the notebook top to bottom on a fresh sandbox and reports what does not reproduce. Use before sharing a notebook with someone else."}]},
};
...
export const WORKERS_AP_INVOICE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['odoo:0.0.1']],
    skills: [(SKILL_MAP['accounting:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['accounting:0.0.1']) : undefined), (SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'file',
...
export const WORKERS_BACKTEST_AUDITOR_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['alphavantage:0.0.1'], MCP_SERVER_MAP['chart:0.0.1']],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'graph',
...
export const WORKERS_CAMPAIGN_PLANNING_AGENTSPEC_0_0_1: Agentspec = {
    ...
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['crawl:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['crawl:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'megaphone',
...
export const WORKERS_CAT_EXPOSURE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    enabled: false,
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['earthdata:0.0.1'], MCP_SERVER_MAP['tavily:0.0.1']],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'shield',
...
export const WORKERS_CHANGE_DETECTION_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['earthdata:0.0.1'], MCP_SERVER_MAP['tavily:0.0.1']],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['crawl:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['crawl:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'telescope',
...
export const WORKERS_CODING_TUTOR_AGENTSPEC_0_0_1: Agentspec = {
    ...
    enabled: false,
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['tavily:0.0.1'], MCP_SERVER_MAP['google-workspace:0.0.1']],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['crawl:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['crawl:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
...
export const WORKERS_COHORT_COMPARISON_AGENTSPEC_0_0_1: Agentspec = {
    ...
    enabled: false,
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['huggingface:0.0.1'], MCP_SERVER_MAP['kaggle:0.0.1']],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['pdf:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['pdf:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
...
export const WORKERS_COMPETITIVE_INTELLIGENCE_AGENTSPEC_0_0_1: Agentspec = {
    ...
    enabled: false,
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [MCP_SERVER_MAP['tavily:0.0.1'], MCP_SERVER_MAP['salesforce:0.0.1']],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['crawl:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['crawl:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1'], TOOL_MAP['runtime-sensitive-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
...
export const WORKERS_CUSTOMER_INTERVIEWER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    model: 'bedrock:us.anthropic.claude-sonnet-4-6',
    mcpServers: [],
    skills: [(SKILL_MAP['text-summarizer:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['text-summarizer:0.0.1']) : undefined), (SKILL_MAP['events:0.0.1'] ? toAgentSkillSpec(SKILL_MAP['events:0.0.1']) : undefined)].filter(Boolean) as SkillSpec[],
    tools: [TOOL_MAP['runtime-echo:0.0.1']],
    frontendTools: [FRONTEND_TOOL_MAP['jupyter-notebook:0.0.1'], FRONTEND_TOOL_MAP['lexical-document:0.0.1']],
    environmentName: 'ai-agents-env',
    icon: 'comment-discussion',
    ...
    welcomeMessage: "Hi! I'm your Customer Interviewer. I'll ask a few open questions and adapt as we go — following up on what you share to understand your motivations and decisions. At the end, I'll turn our conversation into structured, actionable insights.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const WORKERS_NEWS_AGGREGATOR_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I'm your News Aggregator. Tell me the topics, sources, companies, and industries you care about, and I'll deliver a concise daily briefing of what matters most — with the noise filtered out.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
...
export const WORKERS_SOCIAL_MARKETER_AGENTSPEC_0_0_1: Agentspec = {
    ...
    welcomeMessage: "Hi! I'm your Business Marketer. I watch trends and conversations across LinkedIn, X, and Bluesky, flag the best engagement opportunities, suggest who to connect with, and draft platform-ready content. I'll always ask before publishing.",
    welcomeNotebook: undefined,
    welcomeDocument: undefined,
    sandboxVariant: 'jupyter-server',
    harness: 'pydantic-ai',
