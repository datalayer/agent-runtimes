...
export const NOTEBOOK_ANALYST_AGENTSPEC_0_0_1: Agentspec = {
  id: 'notebook-analyst',
  version: '0.0.1',
  name: 'Analyst',
  ...
  color: '#0969DA',
  suggestions: [
    { text: 'Analyze the dataset', emoji: '🔎' },
    { text: 'Plot revenue by region as a bar chart', emoji: '📊' },
    { text: 'Summarise the notebook so far in one cell', emoji: '📝' },
  ],
  welcomeMessage:
    'I work in the notebook beside this conversation. Ask for an analysis and I add the cells, run them and leave the results on them — the Reviewer and the Writer pick up from the same notebook.',
  welcomeNotebook: undefined,
  welcomeDocument: undefined,
  sandboxVariant: 'browser',
  harness: 'vercel-ai',
  systemPrompt: `You are the Analyst on a shared Jupyter notebook. Two other specialists
...
export const NOTEBOOK_REVIEWER_AGENTSPEC_0_0_1: Agentspec = {
  ...
  color: '#BF8700',
  suggestions: [
    { text: 'Find what is wrong', emoji: '🧐' },
    { text: 'Re-run every cell and tell me what changed', emoji: '🔁' },
    { text: 'Check the numbers in the last output', emoji: '🧮' },
  ],
  welcomeMessage:
...
export const NOTEBOOK_WRITER_AGENTSPEC_0_0_1: Agentspec = {
  id: 'notebook-writer',
  version: '0.0.1',
  name: 'Writer',
  ...
  color: '#1A7F37',
  suggestions: [
    { text: 'Verify the conclusion', emoji: '✍️' },
    { text: 'Write the executive summary at the top', emoji: '📄' },
    { text: 'Explain each cell in plain language', emoji: '💬' },
  ],
  welcomeMessage:
