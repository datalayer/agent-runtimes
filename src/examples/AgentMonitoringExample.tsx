...
/**
 * Agent Monitoring, demonstrated as a Loop capacity plugin.
 *
 * The capacity lives in `@datalayer/loop-plugin-agent-monitoring`: the
 ...
 *
 * @module examples/AgentMonitoringExample
 */
...
const AgentMonitoringExample: React.FC = () => {
  ...
  const agentName = useMemo(() => uniqueAgentId('monitoring-example-agent'), []);
  const plugins = useMemo(() => [AgentMonitoringPlugin], []);
  return (
    <ThemedProvider>
