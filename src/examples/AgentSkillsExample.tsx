...
/**
 * Agent Skills, demonstrated as a Loop capacity plugin.
 *
 * The capacity lives in `@datalayer/loop-plugin-agent-skills`: the
 ...
 *
 * @module examples/AgentSkillsExample
 */
...
const AgentSkillsExample: React.FC = () => {
  ...
  const agentName = useMemo(() => uniqueAgentId('skills-example-agent'), []);
  const plugins = useMemo(() => [AgentSkillsPlugin], []);
  return (
    <ThemedProvider>
