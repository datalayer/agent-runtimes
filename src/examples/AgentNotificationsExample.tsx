...
/**
 * Agent Notifications, demonstrated as a Loop capacity plugin.
 *
 * The capacity lives in `@datalayer/loop-plugin-agent-notifications`: the
 ...
 *
 * @module examples/AgentNotificationsExample
 */
...
const AgentNotificationsExample: React.FC = () => {
  ...
  const agentName = useMemo(() => uniqueAgentId('notifications-example-agent'), []);
