...
/**
 * Agent Evals, demonstrated as a Loop capacity plugin.
 *
 * The capacity lives in `@datalayer/loop-plugin-agent-evals`: the
 ...
 *
 * @module examples/AgentEvalsExample
 */
...
const AgentEvalsExample: React.FC = () => {
  ...
  const agentName = useMemo(() => uniqueAgentId('evals-example-agent'), []);
  const plugins = useMemo(() => [AgentEvalsPlugin], []);
  return (
    <ThemedProvider>
