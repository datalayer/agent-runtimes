...
/**
 * Normalize compact one-line markdown tables generated by some models.
 * Example input:
 * | A | B ||---|---|| 1 | 2 |
 */
function normalizeCompactMarkdownTable(text: string): string {
  if (!text || text.includes('\n')) return text;
  // Only apply normalization when a markdown table separator row is present.
