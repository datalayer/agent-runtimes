...
import { CellExample } from './examples2/CellExample';
import { NotebookExample } from './examples2/NotebookExample';

import './AppExamples2.css';
    ...
    <div className="App">
      <>
        <JupyterReactTheme>
          ...
          {serviceManager && (
            <NotebookExample serviceManager={serviceManager} />
          )}
        </JupyterReactTheme>
      </>
      <div>
