...
export const PAGE_TAGE_NONE: PageTag = {
  id: '0',
  text: undefined,
  Icon: CopilotIcon,
  color: 'pink',
...
const PAGE_TAGE_EXAMPLE: PageTag = {
  id: '3',
  text: 'example',
  Icon: CopilotIcon,
  color: 'lime',
};
const PAGE_TAGE_LLM: PageTag = {
  id: '4',
  text: 'llm',
  Icon: CopilotIcon,
  color: 'coral',
...
const PAGE_TAGE_PYTORCH: PageTag = {
  id: '6',
  text: 'pytorch',
  Icon: CopilotIcon,
  color: 'green',
};
const PAGE_TAGE_SPATIAL: PageTag = {
  id: '7',
  text: 'spatial',
  Icon: CopilotIcon,
  color: 'lemon',
};
const PAGE_TAGE_TUTORIAL: PageTag = {
  id: '8',
  text: 'tutorial',
  Icon: CopilotIcon,
  color: 'orange',
