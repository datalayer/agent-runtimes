...
describe('ThemeContext', () => {
  ...
  describe('useTheme', () => {
    ...
    it('should return custom theme when provided', () => {
      ...
      expect(result.current.components.Button).toEqual({
        'custom-class': true,
      });
    });
  });
  ...
  describe('Theme CSS Classes', () => {
    ...
    it('should have Text variants for different usage hints', () => {
      const textTheme = defaultTheme.components.Text as Record<
        string,
    ...
    it('should have Image variants for different usage hints', () => {
      const imageTheme = defaultTheme.components.Image as Record<
        string,
        Record<string, boolean>
      >;
