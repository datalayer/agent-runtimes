                  ...
                  Button: {
                    ...
                    action: {
                      ...
                      context: [
                        {
                          key: 'formId',
                          value: { literalString: 'login-form' },
                        },
                      ],
                    },
                  },
            ...
            components: [
              {
                ...
                component: {
                  Column: {
                    children: { explicitList: ['text-1', 'divider', 'text-2'] },
                  },
                },
              },
              {
            ...
            components: [
              ...
              },
              {
                ...
                component: {
                  Column: {
                    children: {
                      explicitList: ['stat-1-label', 'stat-1-value'],
                    },
                  },
                },
              },
              ...
              },
              {
                id: 'stat-1-value',
                component: {
                  Text: { text: { literalString: '1,234' }, usageHint: 'h2' },
                },
              },
              {
                id: 'stat-2',
                component: {
                  Column: {
                    children: {
                      explicitList: ['stat-2-label', 'stat-2-value'],
                    },
                  },
                },
              },
              ...
              },
              {
                id: 'stat-2-value',
                component: {
                  Text: { text: { literalString: '5,678' }, usageHint: 'h2' },
                },
              },
            ],
          },
