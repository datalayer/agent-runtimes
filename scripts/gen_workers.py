...
WORKERS = {
    # Earth Observation
    "change-detection": ("earth-observation", "Change Detection Worker",
    ...
    "crop-monitoring": ("earth-observation", "Crop Monitoring Worker",
    ...
    "disaster-assessment": ("earth-observation", "Disaster Assessment Worker",
    ...
    "infrastructure-monitoring": ("earth-observation", "Infrastructure Monitoring Worker",
    ...
    "environmental-compliance": ("earth-observation", "Environmental Compliance Worker",
    ...
    # Accounting (Odoo)
    "ap-invoice": ("accounting", "AP Invoice Worker",
    ...
    "bank-reconciliation": ("accounting", "Bank Reconciliation Worker",
    ...
    "month-end-close": ("accounting", "Month-End Close Worker",
    ...
    "collections": ("accounting", "Collections Worker",
    ...
    "expense-audit": ("accounting", "Expense Audit Worker",
    ...
    "audit-pack-builder": ("accounting", "Audit-Pack Builder",
    ...
    "renewable-asset-performance": ("energy", "Renewable Asset Performance Worker",
    ...
    "grid-forecast": ("energy", "Grid Forecast Worker",
    ...
    "curtailment-investigator": ("energy", "Curtailment Investigator",
    ...
    "energy-trading-analyst": ("energy", "Energy Trading Analyst",
    ...
    "predictive-maintenance": ("energy", "Predictive Maintenance Worker",
    ...
    # Insurance
    "cat-exposure": ("insurance", "CAT Exposure Worker",
    ...
    "event-response": ("insurance", "Event Response Worker",
    ...
    "portfolio-accumulation": ("insurance", "Portfolio Accumulation Worker",
    ...
    "exposure-data-quality": ("insurance", "Exposure Data Quality Worker",
    ...
    "model-comparison": ("insurance", "Model Comparison Worker",
    ...
    # Life Sciences
    "rna-seq": ("life-sciences", "RNA-Seq Worker",
    ...
    "variant-analysis": ("life-sciences", "Variant Analysis Worker",
    ...
    "single-cell-processing": ("life-sciences", "Single-Cell Processing Worker",
    ...
    "cohort-comparison": ("life-sciences", "Cohort Comparison Worker",
    ...
    "pipeline-debugger": ("life-sciences", "Pipeline Debugger",
    ...
    "compute-cost-optimizer": ("life-sciences", "Compute-Cost Optimizer",
    ...
    # Capital Markets
    "quant-research": ("capital-markets", "Quant Research Worker",
    ...
    "portfolio-risk": ("capital-markets", "Portfolio Risk Worker",
    ...
    "backtest-auditor": ("capital-markets", "Backtest Auditor",
    ...
    "factor-analysis": ("capital-markets", "Factor Analysis Worker",
    ...
    "performance-attribution": ("capital-markets", "Performance Attribution Worker",
    ...
    "scenario-testing": ("capital-markets", "Scenario Testing Worker",
    ...
    "travel-recommender": ("personal-assistant", "Travel Recommender",
    ...
    "trends-seeker": ("personal-assistant", "Trends Seeker",
    ...
    "product-finder": ("personal-assistant", "Product Finder",
    ...
    "job-hunter": ("personal-assistant", "Job Hunter",
    ...
    "coding-tutor": ("personal-assistant", "Coding Tutor",
    ...
    "mail-triage": ("personal-assistant", "Mail Triage Worker",
    ...
    "campaign-planning": ("marketing", "Campaign Planning Worker",
    ...
    "content-repurposing": ("marketing", "Content Repurposing Worker",
    ...
    "social-listening": ("marketing", "Social Listening Worker",
    ...
    "community-response": ("marketing", "Community Response Worker",
    ...
    "interview-guide": ("market-analyst", "Interview Guide Worker",
    ...
    "research-recruiter": ("market-analyst", "Research Recruiter",
    ...
    "thematic-analysis": ("market-analyst", "Thematic Analysis Worker",
    ...
    "competitive-intelligence": ("market-analyst", "Competitive Intelligence Worker",
    ...
    "evidence-repository": ("market-analyst", "Evidence Repository Worker",
