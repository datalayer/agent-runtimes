...
specs: ## generate Python and TypeScript code from YAML specifications (agents, MCP servers, skills)
	...
	ruff check --select I --fix agent_runtimes/config/agents.py agent_runtimes/config/skills.py agent_runtimes/mcp/catalog_mcp_servers.py
	ruff format agent_runtimes/config/agents.py agent_runtimes/config/skills.py agent_runtimes/mcp/catalog_mcp_servers.py
