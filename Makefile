...
DATALAYER_MCP_SERVER_URL ?= https://r1.datalayer.run/mcp
...
PLANE_LOCAL_MCP_SERVER_URL ?= http://localhost:4404/mcp
...
EXAMPLE_LOCAL_ENV = \
	...
	DATALAYER_MCP_SERVER_URL=$(PLANE_LOCAL_MCP_SERVER_URL) \
	...
	VITE_DATALAYER_MCP_SERVER_URL=$(PLANE_LOCAL_MCP_SERVER_URL) \
