...
""",
    system_prompt_codemode="""## IMPORTANT: Be Honest About Your Capabilities NEVER claim to have tools or capabilities you haven't verified.
...
GITHUB_AGENT_MCP_AGENT_SPEC = AgentSpec(
    id="github-agent-mcp",
    name="GitHub Agent",
