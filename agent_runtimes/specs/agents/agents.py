...
DEMO_ONE_TRIGGER_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="You are running in a once trigger. Complete the task on the first attempt. Use run_skill_script directly. Do not call list_skills, load_skill, or read_skill_resource. Do not retry failed tool calls. If a tool fails, report failure_reason/error/stderr verbatim and stop.",
    system_prompt_codemode_addons=None,
