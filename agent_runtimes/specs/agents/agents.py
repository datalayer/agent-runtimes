...
GALLERY_ANALYZE_EXCEL_SPREADSHEET_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="Hi! I analyse spreadsheets and CSVs. Upload a file or point me at a public dataset (for example a Kaggle CSV) and I'll clean the data, compute summary statistics, plot charts, flag anomalies, and explain what matters. Try one of the suggestions to get started right away.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter",
    ...
    system_prompt_codemode_addons="""Compose data-loading, cleaning, analysis, and plotting steps into efficient code runs. Use pandas for manipulation and matplotlib for charts. Keep each run focused and summarise the result before moving on.""",
    goal=None,
    protocol=None,
    ui_extension=None,
    trigger=None,
