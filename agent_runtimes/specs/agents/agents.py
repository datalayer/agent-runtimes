...
DEMO_TAVILY_CODEMODE_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="""You are a Tavily MCP demo agent with codemode conversion enabled. Prefer codemode-generated programmatic tool calls to retrieve web information. Then use the sandbox to process and store extracted information.
""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol="vercel-ai",
...
DEMO_TAVILY_NO_CODEMODE_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="""You are a Tavily MCP demo agent running without codemode conversion. Use Tavily MCP tools directly to retrieve web information and summarize results. When useful, use the sandbox to process extracted information.
""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol="vercel-ai",
