...
EXAMPLE_BACKEND_TOOL_RENDERING_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Show me the weather forecast for Tokyo.", summary="Tokyo forecast"
        ),
    ],
...
EXAMPLE_CHECKPOINTS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="Checkpoints example agent ready. I snapshot our conversation after every turn; ask me to save a named checkpoint, list them, or rewind to one.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter-server",
    harness="pydantic-ai",
...
EXAMPLE_CODE_SANDBOX_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="Code sandbox agent ready. Ask me to run Python: I execute it in the sandbox and report what it printed.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter-server",
    harness="pydantic-ai",
...
EXAMPLE_CODEMODE_AGENTSPEC_0_0_1 = Agentspec(
    ...
    sandbox_variant="jupyter-server",
    harness="pydantic-ai",
    system_prompt="""You are a Tavily MCP demo assistant with codemode enabled. Prefer concise, practical responses and use the Tavily tools when web search or extraction is needed.
...
EXAMPLE_COMPACTION_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="Compaction example agent ready. Ask me for long answers to fill the context; when it grows past the budget, older turns are summarized and the sidebar shows the compaction.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter-server",
    harness="pydantic-ai",
...
EXAMPLE_DECKS_AGENTSPEC_0_0_1 = Agentspec(
    id="example-decks",
    version="0.0.1",
    name="Decks",
...
EXAMPLE_DOCUMENT_AGENT_SPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        AgentSuggestion(
            text='Insert a heading that says "Welcome"', summary="Insert a heading"
        ),
        AgentSuggestion(
...
EXAMPLE_FULL_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Tell me a joke using your skills.", summary="A joke from your skills"
        ),
    ],
...
EXAMPLE_OTEL_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Give me a summary of the current metrics.", summary="Metrics summary"
        ),
        AgentSuggestion(
...
EXAMPLE_SANDBOX_COLAB_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the google-colab sandbox. Ask me to run Python: it executes on a Google Colab runtime.",
    welcome_notebook=None,
    welcome_document=None,
...
EXAMPLE_SANDBOX_DATALAYER_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the datalayer sandbox. Ask me to run Python: it executes on a Datalayer runtime in the cloud.",
    welcome_notebook=None,
    welcome_document=None,
...
EXAMPLE_SANDBOX_DOCKER_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the docker sandbox. Ask me to run Python: it executes in a container.",
    welcome_notebook=None,
    welcome_document=None,
...
EXAMPLE_SANDBOX_EVAL_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the eval sandbox. Ask me to run Python: it executes in this server's own Python process.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="eval",
    harness="pydantic-ai",
...
EXAMPLE_SANDBOX_JUPYTER_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the jupyter-server sandbox. Ask me to run Python: it executes in a Jupyter kernel the server starts beside itself.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter-server",
    harness="pydantic-ai",
...
EXAMPLE_SANDBOX_KAGGLE_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the kaggle sandbox. Ask me to run Python: it executes on a Kaggle kernel.",
    welcome_notebook=None,
    welcome_document=None,
...
EXAMPLE_SANDBOX_MODAL_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the modal sandbox. Ask me to run Python: it executes on a Modal cloud sandbox.",
    welcome_notebook=None,
    welcome_document=None,
...
EXAMPLE_SANDBOX_MONTY_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="You're connected to the monty sandbox. Ask me to run Python: it executes in the Monty interpreter, a restricted in-process sandbox.",
    welcome_notebook=None,
    welcome_document=None,
...
- Never install a package to work around a bug that is not about packaging. - If the failure is in the data rather than the code, say so instead of
  writing code that hides it.""",
    ...
    goal=None,
    delegable=[
        AgentCapability(id="notebook.run"),
    ],
    protocol=None,
    ui_extension=None,
    trigger=None,
...
""",
    ...
    delegable=[
        AgentCapability(id="notebook.run"),
        AgentCapability(id="data.transform"),
        AgentCapability(id="data.analyse"),
        AgentCapability(id="data.visualise"),
    ],
    protocol=None,
    ui_extension=None,
    trigger=None,
...
- Say plainly when a notebook cannot be run at all, and why.""",
    ...
    delegable=[
        AgentCapability(id="notebook.run"),
        AgentCapability(id="report.author"),
        AgentCapability(id="code.execute"),
    ],
    protocol=None,
    ui_extension=None,
    trigger=None,
...
JUPYTER_NOTEBOOK_WRITER_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        AgentSuggestion(
            text="Verify the conclusion", summary="Verify the conclusion", emoji="✍️"
        ),
        AgentSuggestion(
...
WORKER_ACCOUNTANT_AGENTSPEC_0_0_1 = Agentspec(
    ...
    delegable=[
        AgentCapability(id="data.analyse"),
        AgentCapability(id="document.summarise"),
        AgentCapability(id="document.extract"),
    ],
    protocol=None,
    ui_extension=None,
    trigger=None,
...
WORKER_ANALYZE_SUPPORT_TICKETS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Generate a pattern analysis report", summary="Pattern analysis report"
        ),
    ],
...
""",
    ...
    delegable=[
        AgentCapability(id="data.acquire"),
        AgentCapability(id="data.analyse"),
        AgentCapability(id="support.respond"),
    ],
    protocol="vercel-ai",
    ui_extension="a2ui",
    trigger={
...
WORKER_AP_INVOICE_AGENTSPEC_0_0_1 = Agentspec(
    ...
    delegable=[
        AgentCapability(id="data.extract"),
        AgentCapability(id="data.analyse"),
        AgentCapability(id="document.extract"),
    ],
    protocol="vercel-ai",
...
""",
    ...
    delegable=[
        AgentCapability(id="notebook.validate"),
        AgentCapability(id="data.acquire"),
        AgentCapability(id="data.analyse"),
        AgentCapability(id="document.extract"),
        AgentCapability(id="report.author"),
...
WORKER_BACKTEST_AUDITOR_AGENTSPEC_0_0_1 = Agentspec(
    ...
    delegable=[
        AgentCapability(id="data.analyse"),
        AgentCapability(id="code.review"),
    ],
    protocol="vercel-ai",
    ui_extension="a2ui",
    trigger=None,
...
WORKER_CLASSIFY_ROUTE_EMAILS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    delegable=[
        AgentCapability(id="data.analyse"),
        AgentCapability(id="support.respond"),
        AgentCapability(id="workflow.orchestrate"),
    ],
    protocol="vercel-ai",
    ui_extension="a2ui",
    trigger={
...
WORKER_DATA_ACQUISITION_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="List available files in my workspace", summary="Files in my workspace"
        ),
        AgentSuggestion(
...
WORKER_END_OF_MONTH_PERFORMANCE_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Break down revenue by SKU category", summary="Revenue by category"
        ),
    ],
...
WORKER_FINANCIAL_VIZ_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Get the latest market news for tech stocks", summary="Tech stock news"
        ),
    ],
...
WORKER_GITHUB_AGENT_SPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Show recent commits on the main branch", summary="Recent main commits"
        ),
        AgentSuggestion(
...
WORKER_INFORMATION_ROUTING_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="List recent files in my Drive folder", summary="Recent Drive files"
        ),
        AgentSuggestion(
...
WORKER_MONITOR_SALES_KPIS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        AgentSuggestion(
            text="Show me today's sales KPI dashboard", summary="Today's KPI dashboard"
        ),
        AgentSuggestion(
...
WORKER_OPTIMIZE_GRID_OPERATIONS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Which assets have anomaly alerts right now?", summary="Anomaly alerts"
        ),
        AgentSuggestion(
...
WORKER_PITCHER_AGENTSPEC_0_0_1 = Agentspec(
    id="worker-pitcher",
    version="0.0.1",
    name="Pitcher",
    ...
    welcome_message="I write pitch decks as data. Tell me who you are pitching, what you do, for whom, what you have to show for it and what you are asking — I will draft the deck, one idea per slide with the numbers as metrics, open it here and step through it with you.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="browser",
    harness="vercel-ai",
    system_prompt="""You are the Pitcher, the agent that writes pitch decks. Presentations here
...
WORKER_PROCESS_CITIZEN_REQUESTS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Which requests are overdue for response?", summary="Overdue requests"
        ),
    ],
...
WORKER_PROCESS_CLINICAL_TRIAL_DATA_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Run SDTM validation on the current dataset", summary="SDTM validation"
        ),
        AgentSuggestion(
            text="Generate a safety signal report", summary="Safety signal report"
        ),
        AgentSuggestion(
...
WORKER_PROCESS_FINANCIAL_TRANSACTIONS_AGENTSPEC_0_0_1 = Agentspec(
    ...
    suggestions=[
        ...
        AgentSuggestion(
            text="Generate an AML compliance report", summary="AML compliance report"
        ),
    ],
