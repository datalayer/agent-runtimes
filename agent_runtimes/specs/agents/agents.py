...
DEMO_GUARDRAILS_AGENT_SPEC_0_0_1 = AgentSpec(
    id="demo-guardrails",
    version="0.0.1",
    ...
    model="bedrock:us.anthropic.claude-sonnet-4-5-20250929-v1:0",
    mcp_servers=[],
    skills=["jokes:0.0.1", "events:0.0.1"],
    tools=["runtime-echo:0.0.1", "runtime-sensitive-echo:0.0.1"],
    frontend_tools=["jupyter-notebook:0.0.1", "lexical-document:0.0.1"],
    environment_name="ai-agents-env",
    icon="shield-check",
    ...
    welcome_message="Hi! I am the Guardrails demo agent. I enforce a strict per-run cost budget and require manual approval for sensitive tool calls. ",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="""You are a guardrails demonstration assistant. You can call runtime_echo directly. You must request human approval before running runtime_sensitive_echo. Always provide a concise plain-text summary after each tool execution.
""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol=None,
...
DEMO_MCP_AGENT_SPEC_0_0_1 = AgentSpec(
    id="demo-mcp",
    version="0.0.1",
    name="Demo MCP",
    ...
    welcome_message="Hi! I'm the MCP demo agent. I use MCP tools directly without codemode. ",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant=None,
    system_prompt="""You are a helpful assistant with access to MCP tools. Use Tavily MCP tools to retrieve web information when needed. Do not claim codemode capabilities.
""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol="vercel-ai",
...
DEMO_MONITORING_AGENT_SPEC_0_0_1 = AgentSpec(
    id="demo-monitoring",
    version="0.0.1",
    ...
    model="bedrock:us.anthropic.claude-sonnet-4-5-20250929-v1:0",
    mcp_servers=[MCP_SERVER_CATALOG["tavily"]],
    skills=["datalayer-whoami:0.0.1", "jokes:0.0.1"],
    tools=[],
    frontend_tools=["jupyter-notebook:0.0.1", "lexical-document:0.0.1"],
    environment_name="ai-agents-env",
    icon="graph",
    ...
    welcome_message="Hi! I'm the Monitoring Demo agent. I can use Tavily for web context and datalayer-skills to inspect your authenticated Datalayer identity. ",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="""You are a monitoring-oriented assistant. Use Tavily MCP tools for current web information when useful. Use the datalayer-whoami skill when the user asks about identity, profile, or account context. Keep explanations concise and practical.
""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol=None,
