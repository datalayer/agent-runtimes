...
GUARDRAILS_COST_TRACKING_DEMO_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    welcome_message="Hello! I demonstrate guardrails with budget tracking and approval workflows. I will monitor token/cost usage and require approval for sensitive runtime tools.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="local-eval",
    system_prompt="""You are a guardrails demonstration agent.
...
""",
    ...
    ui_extension=None,
    trigger=None,
    model_configuration={"temperature": 0.2, "max_tokens": 2048},
    mcp_server_tools=None,
    guardrails=[
        {
...
AGENT_SPECS: Dict[str, AgentSpec] = {
    ...
    "guardrails-cost-tracking-demo": GUARDRAILS_COST_TRACKING_DEMO_AGENT_SPEC_0_0_1,
