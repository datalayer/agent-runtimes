...
DEMO_EVALS_AGENT_SPEC_0_0_1 = AgentSpec(
    id="demo-evals",
    version="0.0.1",
    name="Demo Evals",
...
EVAL_SYNTHETIC_RUNNER_AGENT_SPEC_0_0_1 = AgentSpec(
    id="eval-synthetic-runner",
    version="0.0.1",
    name="Eval Synthetic Runner",
    description="Dedicated synthetic eval runner for deterministic no-agent evaluation flows and reproducible testing output.",
    tags=["evals", "synthetic", "runner"],
    enabled=True,
    model="bedrock:us.anthropic.claude-3-5-haiku-20241022-v1:0",
    mcp_servers=[],
    skills=["events:0.0.1"],
    ...
    welcome_message="Ready to run synthetic eval experiments with deterministic outputs.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="""You are the Eval Synthetic Runner. Produce deterministic synthetic evaluation outputs for test and demo workflows.""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol=None,
    ui_extension=None,
...
AGENT_SPECS: Dict[str, AgentSpec] = {
    ...
    "demo-evals": DEMO_EVALS_AGENT_SPEC_0_0_1,
    ...
    "eval-synthetic-runner": EVAL_SYNTHETIC_RUNNER_AGENT_SPEC_0_0_1,
