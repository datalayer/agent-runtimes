...
AGENTIFY_BUSINESS_MARKETER_AGENTSPEC_0_0_1 = Agentspec(
...
AGENTIFY_CUSTOMER_INTERVIEWER_AGENTSPEC_0_0_1 = Agentspec(
...
AGENTIFY_NEWS_AGGREGATOR_AGENTSPEC_0_0_1 = Agentspec(
...
EXAMPLE_MEMORY_AGENTSPEC_0_0_1 = Agentspec(
    ...
    welcome_message="Ready to demonstrate durable memory. Tell me a preference and I can recall it across turns.",
    welcome_notebook=None,
    welcome_document=None,
    sandbox_variant="jupyter",
    system_prompt="""You are the Example Memory Agent. Capture durable user preferences and key facts, recall them accurately when asked, and summarize memory context clearly.""",
    system_prompt_codemode_addons=None,
    goal=None,
    protocol=None,
    ui_extension=None,
...
AGENTSPECS: Dict[str, Agentspec] = {
    ...
    "agentify-customer-interviewer": AGENTIFY_CUSTOMER_INTERVIEWER_AGENTSPEC_0_0_1,
