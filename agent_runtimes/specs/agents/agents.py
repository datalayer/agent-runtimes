...
DEMO_FULL_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    model="bedrock:us.anthropic.claude-sonnet-4-5-20250929-v1:0",
    mcp_servers=[MCP_SERVER_CATALOG["tavily"]],
    skills=['crawl:0.0.1', 'datalayer-whoami:0.0.1', 'events:0.0.1', 'github:0.0.1', 'pdf:0.0.1', 'text-summarizer:0.0.1', 'jokes:0.0.1'],
...
DEMO_ONE_TRIGGER_APPROVAL_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    protocol=None,
    ui_extension=None,
    trigger={'type': 'once', 'description': 'Run once with approval and terminate', 'prompt': 'Use the runtime_sensitive_echo tool once.'},
    model_configuration=None,
    mcp_server_tools=None,
    guardrails=None,
    evals=None,
...
""",
    ...
    post_hooks=None,
    parameters=None,
    subagents=SubAgentsConfig(subagents=[SubAgentSpecConfig(name='researcher', description='Researches topics, gathers facts, and provides detailed analysis', instructions='You are a thorough research assistant. When given a topic: 1. Break it down into key questions 2. Provide well-structured findings with evidence 3. Cite sources or reasoning for each claim 4. Highlight areas of uncertainty or debate Format your response with clear sections and bullet points.\n', can_ask_questions=True, max_questions=3, preferred_mode='sync', typical_complexity='moderate'), SubAgentSpecConfig(name='writer', description='Writes clear, structured content based on research or instructions', instructions='You are a skilled technical writer. When given content to write: 1. Organise information into a logical structure 2. Use clear, concise language appropriate for the audience 3. Include headings, bullet points, and formatting for readability 4. Maintain a professional yet approachable tone Always produce complete, publication-ready text.\n', can_ask_questions=False, preferred_mode='sync', typical_complexity='moderate')], default_model='bedrock:us.anthropic.claude-sonnet-4-5-20250929-v1:0', include_general_purpose=True, max_nesting_depth=0),
)
