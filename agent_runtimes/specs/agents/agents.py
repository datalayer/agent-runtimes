...
DEMO_ONE_TRIGGER_APPROVAL_AGENT_SPEC_0_0_1 = AgentSpec(
    ...
    protocol=None,
    ui_extension=None,
    trigger={'type': 'once', 'description': 'Run once with approval and terminate', 'prompt': "Use the runtime-sensitive-echo tool to echo a summary of the user's top 3 public GitHub repositories ranked by recent activity."},
    model_configuration=None,
    mcp_server_tools=None,
    guardrails=None,
    evals=None,
