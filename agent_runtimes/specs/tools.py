...
DECKS_CREATE_DECK_TOOL_SPEC_0_0_1 = ToolSpec(
    id="decks-create-deck",
    version="0.0.1",
    name="Create a deck",
    description="Create a deck from a complete specification under a short slug, optionally in a collection.",
    tags=["decks", "backend"],
    enabled=True,
    approval="auto",
    timeout=None,
...
DECKS_DELETE_DECK_TOOL_SPEC_0_0_1 = ToolSpec(
...
DECKS_DELETE_SLIDE_TOOL_SPEC_0_0_1 = ToolSpec(
...
DECKS_GET_DECK_TOOL_SPEC_0_0_1 = ToolSpec(
    id="decks-get-deck",
    version="0.0.1",
    name="Get a deck",
    description="One deck by id: its full specification and an outline of its slides (number, type, title).",
    tags=["decks", "backend"],
    enabled=True,
    approval="auto",
    timeout=None,
...
DECKS_INSERT_SLIDE_TOOL_SPEC_0_0_1 = ToolSpec(
    id="decks-insert-slide",
    version="0.0.1",
    name="Insert a slide",
    description="Insert a slide into a deck before the given 1-based position, or at the end.",
    tags=["decks", "backend"],
    enabled=True,
    approval="auto",
    timeout=None,
...
DECKS_LIST_DECKS_TOOL_SPEC_0_0_1 = ToolSpec(
    id="decks-list-decks",
    version="0.0.1",
    name="List decks",
    description="Every deck the decks server holds: id, collection, slug, title, subtitle and slide count.",
    tags=["decks", "backend"],
    enabled=True,
    approval="auto",
    timeout=None,
...
DECKS_UPDATE_DECK_TOOL_SPEC_0_0_1 = ToolSpec(
    id="decks-update-deck",
    version="0.0.1",
    name="Replace a deck",
    description="Replace a deck's whole record — collection, slug and specification — by id.",
    tags=["decks", "backend"],
    enabled=True,
    approval="auto",
    timeout=None,
...
DECKS_UPDATE_SLIDE_TOOL_SPEC_0_0_1 = ToolSpec(
    id="decks-update-slide",
    version="0.0.1",
    name="Replace one slide",
    description="Replace one slide of a deck, by its 1-based number, leaving the rest as they are.",
    tags=["decks", "backend"],
    enabled=True,
    approval="auto",
    timeout=None,
