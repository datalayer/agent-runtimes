    ...
    fields=[
        ...
        TriggerField(
            **{
                ...
                "type": "string",
                "required": False,
                "placeholder": "Handle the incoming event and execute the workflow end-to-end.",
            }
        ),
    ],
)
    ...
    fields=[
        TriggerField(
            **{
                ...
                "type": "string",
                "required": False,
                "placeholder": "Start when requested by a user and complete the workflow once.",
            }
        ),
    ],
)
    ...
    fields=[
        ...
        TriggerField(
            **{
                ...
                "type": "string",
                "required": False,
                "placeholder": "Run the scheduled workflow and produce the configured deliverable.",
            }
        ),
    ],
)
