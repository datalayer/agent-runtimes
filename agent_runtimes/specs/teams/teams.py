...
JUPYTER_NOTEBOOK_TEAM_SPEC_0_0_1 = TeamSpec(
    id="jupyter-notebook",
    version="0.0.1",
...
SHARED_NOTEBOOK_TEAM_SPEC_0_0_1 = TeamSpec(
    id="shared-notebook",
    version="0.0.1",
    ...
    suggestions=[
        TeamSuggestionSpec(text="Analyze the dataset", icon="graph", emoji="🔎"),
        TeamSuggestionSpec(text="Find what is wrong", icon="checklist", emoji="🧐"),
        TeamSuggestionSpec(text="Verify the conclusion", icon="pencil", emoji="✍️"),
        TeamSuggestionSpec(
