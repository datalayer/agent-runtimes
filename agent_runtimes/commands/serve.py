...
def serve_server(
    ...
    Args:
        ...
        sandbox_variant: Code sandbox variant to use ('eval', 'jupyter', or
                           'jupyter'). When 'jupyter', a Jupyter server is started
    ...
    # Store the effective port in an env var so callers (e.g. chat
