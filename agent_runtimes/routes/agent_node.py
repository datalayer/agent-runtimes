...
Configuration (mode, billable principal, sharing) plus the central-service
...
class AgentNodeConfiguration(BaseModel):
    ...
    billable_principal_uid: str | None = None
    billable_principal_type: str | None = None
    billable_principal_handle: str | None = None
